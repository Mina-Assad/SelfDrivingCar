...
#define BUZZ_PIN     13
#define FAST_SPEED  250/energyIndex     //both sides of the motor speed 250
#define SPEED  100/energyIndex     //both sides of the motor speed 100
#define TURN_SPEED  200/energyIndex     //both sides of the motor speed 200
#define BACK_SPEED1  255/energyIndex     //back speed 255
#define BACK_SPEED2  90/energyIndex     //back speed
...
const int turntime1 = 3*turntime;
Servo head;
...
int obstacle_status =B100000;
  ...
  else if(obstacle_str == "01000" || obstacle_str == "11000" || obstacle_str == "11100" || obstacle_str =="01100"){
    return 2;
  }
  else if(obstacle_str == "00100" || obstacle_str == "01110" ){
    return 3;
  }
  else if(obstacle_str == "00010" || obstacle_str == "00011" || obstacle_str == "00111" || obstacle_str == "00110" ){
    return 4;
  }
