...
const int sidedistancelimit = 11; //minimum distance in cm to obstacles at both sides (the car will allow a shorter distance sideways)
int distance;
int numcycles = 0;
const int turntime = 500;  // 45 degree turn
const int backtime = 300; 

const float echolimit = (distancelimit + 1)/0.01657;
